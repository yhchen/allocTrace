...
typedef BOOL _stdcall TREELIST_EDIT_CB(const TREELIST_HANDLE, const void *pAnyPtr, const char *NewData, char *Override); 

// Caller get text call back
typedef VOID _stdcall TREELIST_TEXT_CB(const TREELIST_HANDLE, int ColumnIndex, void *pExternalPtr, char *lpText, int cchTextMax); 
